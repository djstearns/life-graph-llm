...
class Llm:
    ...
    def invoke(self, input_text, model_id, max_tokens=4096, temperature=0.0):
        """
    ...
    def invoke_openai(self, input_text, model_id="gpt-4o-mini", max_tokens=4096, temperature=0.0):
        """
